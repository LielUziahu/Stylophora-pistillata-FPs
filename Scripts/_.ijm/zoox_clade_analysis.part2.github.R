...
indir='/home/gospozha/haifa/hiba/pl_align/Runiq_spis/'
# design file
design_file='/home/gospozha/haifa/hiba/pl_align/design.csv'
design_factor='condition'
# the order of factor levels
design_factor_levels=c("High_fluo", "Non_fluo")
design_sample='id'
# output directory
outidx='/home/gospozha/haifa/hiba/pl_align/Runiq_spis/'
...
prop_table <- speciesFreq2 %>%
  dplyr::mutate(across(-species, ~ . / sum(.))) %>% 
  as.data.frame() 
